...
public class UrlValidatorTest extends TestCase {
   ...
   public void testManualTest()
   {
	   ...
	   assertTrue(urlVal.isValid("www.amazon.com/x/y/z"));
	   assertTrue("Port 8000 should be valid", urlVal.isValid("http://www.amazon.com:8000/abcde"));
	   assertTrue("Query String \"?x=y&y=z\" should be valid", urlVal.isValid("http://www.amazon.com/abcde?x=y&y=z"));
   ...
   public void testYourFirstPartition()
   {
	   ...
	   assertTrue(urlVal.isValid("http://6.5.4.3:65535/?h=j"));
   ...
   public void testYourSecondPartition(){
	   ...
	   assertFalse(urlVal.isValid("http://256.1.2.3"));
   }
